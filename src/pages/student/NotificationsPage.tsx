...
import { Bell, BellOff, Check, CheckCheck, Calendar, HandHeart, AlertCircle, Info } from 'lucide-react';
...
const TYPE_ICONS: Record<string, ReactElement> = {
  ...
  sponsor: <HandHeart size={14} className="text-purple-500" />,
  campaign: <AlertCircle size={14} className="text-orange-500" />,
